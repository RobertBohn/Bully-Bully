...
<xsl:template name="_content" match="_content">
    ...
    <table border="0" cellspacing="0" cellpadding="0"><tr><td valign="top">
        ...
        <table border="0" cellspacing="1" cellpadding="4">
            <tr>
                <th colspan="2">Trade Summary</th>
            </tr>
            <tr>
                <td>Shares Bought</td>
                <td align="right"><xsl:value-of select="format-number(content/amount div content/buyprice, '#', 'usd')"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right">
                    <xsl:if test="navigation/signedin = 'yes'">
                        ...
                        <xsl:attribute name="value"><xsl:value-of select="format-number(content/sellprice, '#.00', 'usd')"/></xsl:attribute>
                        </xsl:element>
                    </xsl:if>

                    <xsl:if test="navigation/signedin != 'yes'">
                        <xsl:value-of select="format-number(content/sellprice, '#.00', 'usd')"/>
                    </xsl:if>
               </td>
           </tr>
            <tr>
            ...
            <xsl:if test="content/sellprice &gt;= content/buyprice">
                <tr>
                    <td>Dollar Gain</td>
                    <td align="right"><img src="images/up.gif" alt="up" /><xsl:value-of select="format-number((content/amount div content/buyprice) * (content/sellprice - content/buyprice), '$#,###', 'usd')"/></td>
                </tr>
                <tr>
                    <td>Percent Gain</td>
                    <td align="right"><img src="images/up.gif" alt="up" /><xsl:value-of select="format-number((content/sellprice - content/buyprice) div content/buyprice, '#%', 'usd')"/></td>
                </tr>
            </xsl:if>
            ...
            <xsl:if test="content/sellprice &lt; content/buyprice">
                <tr>
                    <td>Dollar Gain</td>
                    <td align="right"><img src="images/down.gif" alt="down" /><xsl:value-of select="format-number((content/amount div content/buyprice) * (content/buyprice - content/sellprice), '$#,###', 'usd')"/></td>
                </tr>
                <tr>
                    <td>Percent Gain</td>
                    <td align="right"><img src="images/down.gif" alt="down" /><xsl:value-of select="format-number((content/buyprice - content/sellprice) div content/buyprice, '#%', 'usd')"/></td>
                </tr>
            </xsl:if>
        ...
        <table border="0" cellspacing="1" cellpadding="4">
            ...
            <tr>
                ...
                <td align="center">
                    <xsl:call-template name="formatdate">
                        <xsl:with-param name="date" select="content/selldate" />
                    </xsl:call-template>
                </td>
                <td align="right"><xsl:value-of select="format-number(content/sellprice, '#.00', 'usd')"/></td>
            </tr>
            <tr>
                <td>Current Price</td>
                <td align="center">
                ...
                <td align="right">
                    <xsl:if test="content/enabled = 'Y'">
                        <xsl:value-of select="format-number(content/price, '#.00', 'usd')"/>
                    </xsl:if>
                </td>
            </tr>
        </table>
        ...
        <ul class="backbutton">
            <li><a title="Return to the trades page" href="javascript:history.go(-1);">Back</a></li>
        </ul>
