...
addNode ( $doc, $navigation, 'pagedescr', 'Create a New Stock' );
addNode ( $doc, $navigation, 'title', 'Bully Bully - New Stock' );
addNode ( $doc, $navigation, 'pagename', 'Administration - New Stock' );
